...
import { addProduct, deleteProductById, fetchProductById, fetchProducts, updateProductById, fetchProductByKeyword } from "./ProductApi";
...
export const fetchProductsAsync = createAsyncThunk("products/fetchProductsAsync", async (category = "") => {
...
export const fetchProductByKeywordAsync = createAsyncThunk("products/fetchProductByKeywordAsync", async (keyword) => {
    const products = await fetchProductByKeyword(keyword)
    return products
})
...
const productSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(fetchProductByKeywordAsync.pending, (state) => {
                state.productFetchStatus = 'pending'
            })
            .addCase(fetchProductByKeywordAsync.fulfilled, (state, action) => {
                state.productFetchStatus = 'fullfilled'
                state.products = action.payload
            })
            .addCase(fetchProductByKeywordAsync.rejected, (state, action) => {
                state.productFetchStatus = 'rejected'
                state.errors = action.error
            })
