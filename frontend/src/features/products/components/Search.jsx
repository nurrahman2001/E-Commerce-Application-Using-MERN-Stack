...
import { fetchProductByKeywordAsync, selectProducts, selectProductFetchStatus } from "../ProductSlice";
...
export const Search = () => {
    ...
    // Get the keyword from URL query parameters
    const queryParams = new URLSearchParams(location.search);
    const searchKeyword = queryParams.get("query");

    useEffect(() => {
        dispatch(fetchProductByKeywordAsync(searchKeyword || ""));
    ...
    return (
        <div className="p-10 max-w-7xl mx-auto">
            ...
            <div className="flex items-center gap-2 self-start mb-4">
                ...
                <h3 className="text-gray-700 text-2xl">{searchKeyword ? `Results for: ${searchKeyword}` : "null"}</h3>
            </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        {currentProducts.map((product) => (
                            <div
                                ...
                                className="cursor-pointer border p-4  shadow-lg hover:scale-105 transition"
                            >
            ...
            {
                products.length === 0 && <h2 className="text-center text-2xl text-gray-700 mt-10">No products found</h2>
            }
        </div>
    )
}